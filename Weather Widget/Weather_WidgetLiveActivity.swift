...
struct Weather_WidgetLiveActivity_Previews: PreviewProvider {
    static let attributes = Weather_WidgetAttributes(name: "Me")
    static let contentState = Weather_WidgetAttributes.ContentState(value: 3)
